...
def main():
    ...
    # use the training datset also as validation set. This is relevant for logging of accurracy and loss because for testing no augmentation is used in transforms.
    dataset_test = DigitDataset('./training_data', train=False, transform=test_transforms)
